...
class ServicioTest extends TestCase
{
    ...
    public function test_obtener_lista_de_servicios_paginada()
    {
        ...
        $response = $this->getJson('/api/servicio?per_page=10');
    ...
    public function test_obtener_todos_los_servicios()
    {
        ...
        $response = $this->getJson('/api/servicio/all');
    ...
    public function test_crear_servicio()
    {
        ...
        $response = $this->postJson('/api/servicio', $data);
    ...
    public function test_obtener_servicio_por_id()
    {
        ...
        $response = $this->getJson("/api/servicio/{$servicio->id}");
    ...
    {
        $response = $this->getJson('/api/servicio/999');
    ...
    public function test_actualizar_servicio()
    {
        ...
        $response = $this->putJson("/api/servicio/{$servicio->id}", $data);
    ...
    public function test_eliminar_servicio()
    {
        ...
        $response = $this->deleteJson("/api/servicio/{$servicio->id}");
    ...
    public function test_obtener_hoteles_asociados_a_un_servicio()
    {
        ...
        $response = $this->getJson("/api/servicio/{$servicio->id}/hoteles");
